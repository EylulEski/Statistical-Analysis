...
ws_9cax_w1<-complexNBDAdata(label="diff_ws_9cax_w1",assMatrix=ws_9cax_w1,orderAcq = oa_ws_9cax_word1,demons = demons, assMatrixIndex = Index_9cax_word1)
ws_9cax_w2<-complexNBDAdata(label="diff_ws_9cax_w2",assMatrix=ws_9cax_w2,orderAcq = oa_ws_9cax_word2,demons = demons, assMatrixIndex = Index_9cax_word2)
ws_9cax_w3<-complexNBDAdata(label="diff_ws_9cax_w3",assMatrix=ws_9cax_w3,orderAcq = oa_ws_9cax_word3,demons = demons, assMatrixIndex = Index_9cax_word3)
ws_9cax_w4<-complexNBDAdata(label="diff_ws_9cax_w4",assMatrix=ws_9cax_w4,orderAcq = oa_ws_9cax_word4,demons = demons, assMatrixIndex = Index_9cax_word4)
ws_9cax_w5<-complexNBDAdata(label="diff_ws_9cax_w5",assMatrix=ws_9cax_w5,orderAcq = oa_ws_9cax_word5,demons = demons, assMatrixIndex = Index_9cax_word5)

ws_hg73_w1<-complexNBDAdata(label="diff_ws_hg73_w1",assMatrix=ws_hg73_w1,orderAcq = oa_ws_hg73_word1,demons = demons, assMatrixIndex = Index_hg73_word1)
ws_hg73_w2<-complexNBDAdata(label="diff_ws_hg73_w2",assMatrix=ws_hg73_w2,orderAcq = oa_ws_hg73_word2,demons = demons, assMatrixIndex = Index_hg73_word2)
ws_hg73_w3<-complexNBDAdata(label="diff_ws_hg73_w3",assMatrix=ws_hg73_w3,orderAcq = oa_ws_hg73_word3,demons = demons, assMatrixIndex = Index_hg73_word3)
ws_hg73_w4<-complexNBDAdata(label="diff_ws_hg73_w4",assMatrix=ws_hg73_w4,orderAcq = oa_ws_hg73_word4,demons = demons, assMatrixIndex = Index_hg73_word4)
ws_hg73_w5<-complexNBDAdata(label="diff_ws_hg73_w5",assMatrix=ws_hg73_w5,orderAcq = oa_ws_hg73_word5,demons = demons, assMatrixIndex = Index_hg73_word5)

ws_j8urh_w1<-complexNBDAdata(label="diff_ws_j8urh_w1",assMatrix=ws_j8urh_w1,orderAcq = oa_ws_j8urh_word1,demons = demons, assMatrixIndex = Index_j8urh_word1)
ws_j8urh_w2<-complexNBDAdata(label="diff_ws_j8urh_w2",assMatrix=ws_j8urh_w2,orderAcq = oa_ws_j8urh_word2,demons = demons, assMatrixIndex = Index_j8urh_word2)
ws_j8urh_w3<-complexNBDAdata(label="diff_ws_j8urh_w3",assMatrix=ws_j8urh_w3,orderAcq = oa_ws_j8urh_word3,demons = demons, assMatrixIndex = Index_j8urh_word3)
ws_j8urh_w4<-complexNBDAdata(label="diff_ws_j8urh_w4",assMatrix=ws_j8urh_w4,orderAcq = oa_ws_j8urh_word4,demons = demons, assMatrixIndex = Index_j8urh_word4)
ws_j8urh_w5<-complexNBDAdata(label="diff_ws_j8urh_w5",assMatrix=ws_j8urh_w5,orderAcq = oa_ws_j8urh_word5,demons = demons, assMatrixIndex = Index_j8urh_word5)

ws_slpk_w1<-complexNBDAdata(label="diff_ws_slpk_w1",assMatrix=ws_slpk_w1,orderAcq = oa_ws_slpk_word1,demons = demons, assMatrixIndex = Index_slpk_word1)
ws_slpk_w2<-complexNBDAdata(label="diff_ws_slpk_w2",assMatrix=ws_slpk_w2,orderAcq = oa_ws_slpk_word2,demons = demons, assMatrixIndex = Index_slpk_word2)
ws_slpk_w3<-complexNBDAdata(label="diff_ws_slpk_w3",assMatrix=ws_slpk_w3,orderAcq = oa_ws_slpk_word3,demons = demons, assMatrixIndex = Index_slpk_word3)
ws_slpk_w4<-complexNBDAdata(label="diff_ws_slpk_w4",assMatrix=ws_slpk_w4,orderAcq = oa_ws_slpk_word4,demons = demons, assMatrixIndex = Index_slpk_word4)
ws_slpk_w5<-complexNBDAdata(label="diff_ws_slpk_w5",assMatrix=ws_slpk_w5,orderAcq = oa_ws_slpk_word5,demons = demons, assMatrixIndex = Index_slpk_word5)


#data.frame(Variable=model_dynamic@varNames,MLE=model_dynamic@outputPar,SE=model_dynamic@se)
multiDiffModel1<-complexOadaFit(list(ws_9cax_w1, ws_9cax_w2, ws_9cax_w3, ws_9cax_w4, ws_9cax_w5, ws_hg73_w1, ws_hg73_w2, ws_hg73_w3, ws_hg73_w4, ws_hg73_w5, ws_j8urh_w1, ws_j8urh_w2, ws_j8urh_w3, ws_j8urh_w4, ws_j8urh_w5, ws_slpk_w1, ws_slpk_w2, ws_slpk_w3, ws_slpk_w4, ws_slpk_w5))
multiDiffModel2<-complexOadaFit(list(ws_9cax_w1, ws_9cax_w2, ws_9cax_w3, ws_9cax_w4, ws_9cax_w5, ws_hg73_w1, ws_hg73_w2, ws_hg73_w3, ws_hg73_w4, ws_hg73_w5, ws_j8urh_w1, ws_j8urh_w2, ws_j8urh_w3, ws_j8urh_w4, ws_j8urh_w5, ws_slpk_w1, ws_slpk_w2, ws_slpk_w3, ws_slpk_w4, ws_slpk_w5), type= "asocial")

data.frame(Variable=multiDiffModel1@varNames,MLE=multiDiffModel1@outputPar,SE=multiDiffModel1@se)

#KEYWORD_1
multiDiffW1<-complexOadaFit(list(ws_9cax_w1, ws_hg73_w1, ws_j8urh_w1, ws_slpk_w1))
data.frame(Variable=multiDiffW1@varNames,MLE=multiDiffW1@outputPar,SE=multiDiffW1@se)
nbdaPropSolveByST(model=multiDiffW1)

#KEYWORD_2
multiDiffW2<-complexOadaFit(list(ws_9cax_w2, ws_hg73_w2, ws_j8urh_w2, ws_slpk_w2))
data.frame(Variable=multiDiffW2@varNames,MLE=multiDiffW2@outputPar,SE=multiDiffW2@se)
nbdaPropSolveByST(model=multiDiffW2)

#KEYWORD_3
multiDiffW3<-complexOadaFit(list(ws_9cax_w3, ws_hg73_w3, ws_j8urh_w3, ws_slpk_w3))
data.frame(Variable=multiDiffW3@varNames,MLE=multiDiffW3@outputPar,SE=multiDiffW3@se)


#KEYWORD_4
multiDiffW4<-complexOadaFit(list(ws_9cax_w4, ws_hg73_w4, ws_j8urh_w4, ws_slpk_w4))
data.frame(Variable=multiDiffW4@varNames,MLE=multiDiffW4@outputPar,SE=multiDiffW4@se)
nbdaPropSolveByST(model=multiDiffW4)

#KEYWORD_5
multiDiffW5<-complexOadaFit(list(ws_9cax_w5, ws_hg73_w5, ws_j8urh_w5, ws_slpk_w5))
data.frame(Variable=multiDiffW5@varNames,MLE=multiDiffW5@outputPar,SE=multiDiffW5@se)

multiDiffModel1@aicc #120 #both yielded the same values
multiDiffModel2@aicc #120
#compare the social and asocial models
multiDiffModel2@aicc-multiDiffModel1@aicc 
...
nbdaPropSolveByST(model=multiDiffModel1) #gives error


exp(0.5*(multiDiffModel2@aicc-multiDiffModel1@aicc)) #1
...
2*(multiDiffModel2@loglik-multiDiffModel1@loglik) #0

#There is 1 parameter in model_social, and 0 in model_asocial, so we have 1 d.f.
pchisq(2*(multiDiffModel2@loglik-multiDiffModel1@loglik),df=1,lower.tail=F) #1
...
###################################################
#Fit the models
random_b948_w1<-complexNBDAdata(label="diff_ws_b948_w1",assMatrix=random_b948_w1,orderAcq = oa_random_b948_word1,demons = demons, assMatrixIndex = Index_b948_word1)
random_b948_w2<-complexNBDAdata(label="diff_ws_b948_w2",assMatrix=random_b948_w2,orderAcq = oa_random_b948_word2,demons = demons, assMatrixIndex = Index_b948_word2)
random_b948_w3<-complexNBDAdata(label="diff_ws_b948_w3",assMatrix=random_b948_w3,orderAcq = oa_random_b948_word3,demons = demons, assMatrixIndex = Index_b948_word3)
random_b948_w4<-complexNBDAdata(label="diff_ws_b948_w4",assMatrix=random_b948_w4,orderAcq = oa_random_b948_word4,demons = demons, assMatrixIndex = Index_b948_word4)

random_jdf4_w1<-complexNBDAdata(label="diff_random_jdf4_w1",assMatrix=random_jdf4_w1,orderAcq = oa_random_jdf4_word1,demons = demons, assMatrixIndex = Index_jdf4_word1)
random_jdf4_w2<-complexNBDAdata(label="diff_random_jdf4_w2",assMatrix=random_jdf4_w2,orderAcq = oa_random_jdf4_word2,demons = demons, assMatrixIndex = Index_jdf4_word2)
random_jdf4_w3<-complexNBDAdata(label="diff_random_jdf4_w3",assMatrix=random_jdf4_w3,orderAcq = oa_random_jdf4_word3,demons = demons, assMatrixIndex = Index_jdf4_word3)
random_jdf4_w5<-complexNBDAdata(label="diff_random_jdf4_w5",assMatrix=random_jdf4_w5,orderAcq = oa_random_jdf4_word5,demons = demons, assMatrixIndex = Index_jdf4_word5)

random_ot0u_w1<-complexNBDAdata(label="diff_random_ot0u_w1",assMatrix=random_ot0u_w1,orderAcq = oa_random_ot0u_word1,demons = demons, assMatrixIndex = Index_ot0u_word1)
random_ot0u_w2<-complexNBDAdata(label="diff_random_ot0u_w2",assMatrix=random_ot0u_w2,orderAcq = oa_random_ot0u_word2,demons = demons, assMatrixIndex = Index_ot0u_word2)
random_ot0u_w3<-complexNBDAdata(label="diff_random_ot0u_w3",assMatrix=random_ot0u_w3,orderAcq = oa_random_ot0u_word3,demons = demons, assMatrixIndex = Index_ot0u_word3)
random_ot0u_w4<-complexNBDAdata(label="diff_random_ot0u_w4",assMatrix=random_ot0u_w4,orderAcq = oa_random_ot0u_word4,demons = demons, assMatrixIndex = Index_ot0u_word4)
random_ot0u_w5<-complexNBDAdata(label="diff_random_ot0u_w5",assMatrix=random_ot0u_w5,orderAcq = oa_random_ot0u_word5,demons = demons, assMatrixIndex = Index_ot0u_word5)

random_sdth_w1<-complexNBDAdata(label="diff_random_sdth_w1",assMatrix=random_sdth_w1,orderAcq = oa_random_sdth_word1,demons = demons, assMatrixIndex = Index_sdth_word1)
random_sdth_w3<-complexNBDAdata(label="diff_random_sdth_w3",assMatrix=random_sdth_w3,orderAcq = oa_random_sdth_word3,demons = demons, assMatrixIndex = Index_sdth_word3)
random_sdth_w4<-complexNBDAdata(label="diff_random_sdth_w4",assMatrix=random_sdth_w4,orderAcq = oa_random_sdth_word4,demons = demons, assMatrixIndex = Index_sdth_word4)
random_sdth_w5<-complexNBDAdata(label="diff_random_sdth_w5",assMatrix=random_sdth_w5,orderAcq = oa_random_sdth_word5,demons = demons, assMatrixIndex = Index_sdth_word5)


#data.frame(Variable=model_dynamic@varNames,MLE=model_dynamic@outputPar,SE=model_dynamic@se)
random_multiDiffModel1<-complexOadaFit(list(random_b948_w1, random_b948_w2, random_b948_w3, random_b948_w4, random_jdf4_w1, random_jdf4_w2, random_jdf4_w3, random_jdf4_w5, random_ot0u_w1, random_ot0u_w2, random_ot0u_w3, random_ot0u_w4, random_ot0u_w5, random_sdth_w1, random_sdth_w3, random_sdth_w4, random_sdth_w5))
random_multiDiffModel2<-complexOadaFit(list(random_b948_w1, random_b948_w2, random_b948_w3, random_b948_w4, random_jdf4_w1, random_jdf4_w2, random_jdf4_w3, random_jdf4_w5, random_ot0u_w1, random_ot0u_w2, random_ot0u_w3, random_ot0u_w4, random_ot0u_w5, random_sdth_w1, random_sdth_w3, random_sdth_w4, random_sdth_w5), type= "asocial")

data.frame(Variable=random_multiDiffModel1@varNames,MLE=random_multiDiffModel1@outputPar,SE=random_multiDiffModel1@se)

#KEYWORD_1
random_multiDiffW1<-complexOadaFit(list(random_b948_w1, random_jdf4_w1, random_ot0u_w1, random_sdth_w1))
data.frame(Variable=random_multiDiffW1@varNames,MLE=random_multiDiffW1@outputPar,SE=random_multiDiffW1@se)

#KEYWORD_2
random_multiDiffW2<-complexOadaFit(list(random_b948_w2, random_jdf4_w2, random_ot0u_w2))
data.frame(Variable=random_multiDiffW2@varNames,MLE=random_multiDiffW2@outputPar,SE=random_multiDiffW2@se)

#KEYWORD_3
random_multiDiffW3<-complexOadaFit(list(random_b948_w3, random_jdf4_w3, random_ot0u_w3, random_sdth_w3))
data.frame(Variable=random_multiDiffW3@varNames,MLE=random_multiDiffW3@outputPar,SE=random_multiDiffW3@se)

#KEYWORD_4
random_multiDiffW4<-complexOadaFit(list(random_b948_w4, random_ot0u_w4, random_sdth_w4))
data.frame(Variable=random_multiDiffW4@varNames,MLE=random_multiDiffW4@outputPar,SE=random_multiDiffW4@se)

#KEYWORD_5
random_multiDiffW5<-complexOadaFit(list(random_jdf4_w5, random_ot0u_w5, random_sdth_w5))
